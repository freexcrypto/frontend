  ...
  return (
    <div className="space-y-5">
      <section className="grid grid-cols-1 xl:grid-cols-3 gap-5">
        <div className="border p-5 rounded-md bg-muted">
          <h1 className="text-2xl font-bold">Ultra-Low Fees</h1>
          <p>
            Just a 0.1% processing fee per transaction—keep more of your
            earnings.
          </p>
        </div>
        <div className="border p-5 rounded-md bg-muted">
        ...
        <div className="border p-5 rounded-md bg-muted">
          ...
          <p>Payments in IDRX mean you never worry about crypto crashes.</p>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 xl:grid-cols-2 gap-5 max-w-2xl mx-auto">
        <div className="border p-5 rounded-md bg-muted">
          ...
          <p>
            Track every payment, manage every invoice, and withdraw anytime.
          </p>
        </div>
        <div className="border p-5 rounded-md bg-muted">
